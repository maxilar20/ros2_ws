...
def generate_launch_description():
    ...
    servo_params = {
        "moveit_servo_baxter": ParameterBuilder("moveit_servo_baxter")
    ...
    # RViz
    rviz_config_file = (
        get_package_share_directory("moveit_servo_baxter")
    ...
    container = launch_ros.actions.ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            launch_ros.descriptions.ComposableNode(
                ...
                plugin="moveit_servo_baxter::ServoNode",
                name="servo_node",
                parameters=[
                    servo_params,
                    moveit_config.robot_description,
            ...
            launch_ros.descriptions.ComposableNode(
                package="moveit_servo_baxter",
                plugin="moveit_servo_baxter::JoyToServoPub",
