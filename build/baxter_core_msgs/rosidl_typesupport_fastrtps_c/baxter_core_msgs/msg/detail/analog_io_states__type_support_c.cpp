  ...
  // Field name: states
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, baxter_core_msgs, msg, AnalogIOState
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _AnalogIOStates__ros_msg_type * ros_message = static_cast<_AnalogIOStates__ros_msg_type *>(untyped_ros_message);
  // Field name: names
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
