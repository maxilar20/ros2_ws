...
#ifndef BAXTER_CORE_MSGS__SRV__DETAIL__OPEN_CAMERA__FUNCTIONS_H_
#define BAXTER_CORE_MSGS__SRV__DETAIL__OPEN_CAMERA__FUNCTIONS_H_
...
/// Initialize srv/OpenCamera message.
/**
...
/// Finalize srv/OpenCamera message.
/**
...
/// Create srv/OpenCamera message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * baxter_core_msgs__srv__OpenCamera_Request__init().
...
/// Destroy srv/OpenCamera message.
/**
 * It calls
 * baxter_core_msgs__srv__OpenCamera_Request__fini()
...
/// Check for srv/OpenCamera message equality.
/**
...
/// Initialize array of srv/OpenCamera messages.
/**
...
/// Finalize array of srv/OpenCamera messages.
/**
 * It calls
 * baxter_core_msgs__srv__OpenCamera_Request__fini()
...
/// Create array of srv/OpenCamera messages.
/**
 * It allocates the memory for the array and calls
 * baxter_core_msgs__srv__OpenCamera_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OpenCamera messages.
/**
 * It calls
 * baxter_core_msgs__srv__OpenCamera_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/OpenCamera message array equality.
/**
...
/// Copy an array of srv/OpenCamera messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * baxter_core_msgs__srv__OpenCamera_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_baxter_core_msgs
...
/**
 * It calls
 * baxter_core_msgs__srv__OpenCamera_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_baxter_core_msgs
...
/**
 * It allocates the memory for the array and calls
 * baxter_core_msgs__srv__OpenCamera_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_baxter_core_msgs
...
/**
 * It calls
 * baxter_core_msgs__srv__OpenCamera_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BAXTER_CORE_MSGS__SRV__DETAIL__OPEN_CAMERA__FUNCTIONS_H_
