...
bool baxter_core_msgs__msg__bridge_publisher__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("baxter_core_msgs.msg._bridge_publisher.BridgePublisher", full_classname_dest, 54) == 0);
  }
  baxter_core_msgs__msg__BridgePublisher * ros_message = _ros_message;
  {  // topic
...
{
  /* NOTE(esteve): Call constructor of BridgePublisher */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("baxter_core_msgs.msg._bridge_publisher");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BridgePublisher");
