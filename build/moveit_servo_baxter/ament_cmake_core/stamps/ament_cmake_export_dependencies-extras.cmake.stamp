...
set(_exported_dependencies "control_msgs;control_toolbox;geometry_msgs;moveit_core;moveit_msgs;moveit_ros_planning;pluginlib;rclcpp;rclcpp_components;realtime_tools;sensor_msgs;std_msgs;std_srvs;tf2_eigen;trajectory_msgs")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to moveit_servo_baxter_DEFINITIONS, moveit_servo_baxter_INCLUDE_DIRS,
# moveit_servo_baxter_LIBRARIES, and moveit_servo_baxter_LINK_FLAGS.
# Additionally collect the direct dependency names in
# moveit_servo_baxter_DEPENDENCIES as well as the recursive dependency names
# in moveit_servo_baxter_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(moveit_servo_baxter_DEPENDENCIES ${_exported_dependencies})
  set(moveit_servo_baxter_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(moveit_servo_baxter_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(moveit_servo_baxter_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(moveit_servo_baxter_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(moveit_servo_baxter_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(moveit_servo_baxter_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND moveit_servo_baxter_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
