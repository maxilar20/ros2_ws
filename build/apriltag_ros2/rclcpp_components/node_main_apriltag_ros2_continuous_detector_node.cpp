...
#define NODE_MAIN_LOGGER_NAME "apriltag_ros2_continuous_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libapriltag_ros2_continuous_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<apriltag_ros2::ContinuousDetector>";
