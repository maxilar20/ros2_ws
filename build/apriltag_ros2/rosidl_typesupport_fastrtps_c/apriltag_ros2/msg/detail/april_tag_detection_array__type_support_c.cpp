...
#include "apriltag_ros2/msg/detail/april_tag_detection_array__rosidl_typesupport_fastrtps_c.h"
...
#include "apriltag_ros2/msg/detail/april_tag_detection__functions.h"  // detections
...
using _AprilTagDetectionArray__ros_msg_type = apriltag_ros2__msg__AprilTagDetectionArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, apriltag_ros2, msg, AprilTagDetection
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      apriltag_ros2__msg__AprilTagDetection__Sequence__fini(&ros_message->detections);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_apriltag_ros2__msg__AprilTagDetection(
...
static uint32_t _AprilTagDetectionArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_apriltag_ros2__msg__AprilTagDetectionArray(
  ...
  size_t current_alignment)
{
  ...
  // member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_apriltag_ros2__msg__AprilTagDetection(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _AprilTagDetectionArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_apriltag_ros2__msg__AprilTagDetectionArray(
