...
static const _AprilTagDetection_type_support_symbol_names_t _AprilTagDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apriltag_ros2, msg, AprilTagDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, apriltag_ros2, msg, AprilTagDetection)),
  }
};
...
{
  return &::apriltag_ros2::msg::rosidl_typesupport_cpp::AprilTagDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, apriltag_ros2, msg, AprilTagDetection)() {
  return get_message_type_support_handle<apriltag_ros2::msg::AprilTagDetection>();
}
