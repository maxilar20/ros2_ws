...
#ifndef APRILTAG_ROS2__SRV__DETAIL__ANALYZE_SINGLE_IMAGE__FUNCTIONS_H_
#define APRILTAG_ROS2__SRV__DETAIL__ANALYZE_SINGLE_IMAGE__FUNCTIONS_H_
 ...
 * calls
 * apriltag_ros2__srv__AnalyzeSingleImage_Request__init().
...
/**
 * It calls
 * apriltag_ros2__srv__AnalyzeSingleImage_Request__fini()
 ...
 * apriltag_ros2__srv__AnalyzeSingleImage_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * apriltag_ros2__srv__AnalyzeSingleImage_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * apriltag_ros2__srv__AnalyzeSingleImage_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_apriltag_ros2
...
/**
 * It calls
 * apriltag_ros2__srv__AnalyzeSingleImage_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_apriltag_ros2
...
/**
 * It allocates the memory for the array and calls
 * apriltag_ros2__srv__AnalyzeSingleImage_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_apriltag_ros2
...
/**
 * It calls
 * apriltag_ros2__srv__AnalyzeSingleImage_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // APRILTAG_ROS2__SRV__DETAIL__ANALYZE_SINGLE_IMAGE__FUNCTIONS_H_
